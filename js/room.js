...
// let notificationsContainer = document.getElementById('notifications__container');
...
//   saveTasks(tasks);
//   displayTasks();
//   // Send an event to the connected users in the room
//   broadcastTaskEvent('taskAdded', task);
// };
...
//   displayTasks();
//   // Send an event to the connected users in the room
//   broadcastTaskEvent('taskEdited', { index, newTask });
// };
...
//   displayTasks();
//   // Send an event to the connected users in the room
//   broadcastTaskEvent('taskDeleted', index);
// };

// const broadcastTaskEvent = async (eventType, payload) => {
//   const taskEventMessage = JSON.stringify({
//     type: 'taskEvent',
//     eventType,
//     payload
//   });
//   await channel.sendMessage({ text: taskEventMessage });
// };
...
//   const tasks = getSavedTasks();
//   const taskList = document.getElementById('.goals__container #taskList');
//   taskList.innerHTML = '';
